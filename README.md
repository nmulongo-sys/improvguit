...
- 205 assertions jsdom au vert sur clone nu (183 + 22). Le bourdon échappant à jsdom, qui n'implémente pas Web Audio, il a été vérifié séparément sur un `AudioContext` simulé : une tenue par tour et non par mesure, hauteur prise sur le premier accord, rapport d'octave exact, durée égale à la boucle, silence complet quand le réglage est coupé.
